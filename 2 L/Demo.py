...
class Demo:
	...
	def bar2(self):
		...
		chart.menu.values = [
								...
								{"text": "Eugenuity", "javascript-function": "openEugenuity"},
							]
	...
	def bar3(self):
		...
		# First line data tags
		element2Tags = Chart()
		element2Tags.type = "tags"
		element2Tags.values = [{"x": x, "y": 5*math.sin(x) + 10} for x in range(0, 12)] + [{"x": 2, "y": 20, "text": "A tagged data point"}]
		
		# First line data arrow
		element2Arrow = Chart()
		element2Arrow.type = "arrow"
		element2Arrow.colour = "#ff00ff"
		element2Arrow.start.x = 2
		element2Arrow.start.y = 20
		element2Arrow.end.x = 1.2
		element2Arrow.end.y = 16
		element2Arrow.barb_length = 10
		...
		# Add data to chart object
		chart.elements = [element1, element2, element2Tags, element2Arrow]
	...
	def radar(self):
		...
		chart.radar_axis.spoke_labels.labels = ["one", "two", "three", "four", "five", "six", "seven", "eight"]
		chart.tooltip.mouse = 1
	...
	def candle(self):
		...
		element1.negative_colour = "#e02020"
